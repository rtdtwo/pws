...
const char* MQTT_SERVER   = "YOUR_MQTT_SERVER_HOSTNAME";
const uint16_t MQTT_PORT  = 1883;

const char* MQTT_USERNAME = "YOUR_MQTT_USERNAME";
const char* MQTT_PASSWORD = "YOUR_MQTT_PASSWORD";

const char* MQTT_CLIENT_ID = "esp32-weather-01";

// Topic where the sensor payload will be published
const char* MQTT_TOPIC = "sensors/esp32-weather-01/state";
...
// ============================================================
//
// The payload is used for BOTH MQTT and HTTP.
//
...
void postToNextJS(
  ...
  Serial.println("Sending HTTP POST to Next.js...");
